...
<head>
    ...
    <title>Welcome To TSC E- Recruitment</title>
                    ...
                    <tr>
                      ...
                      <td><label>
                        <select name="cmbQual" id="cmbQual">
                          <option value="B.C.A">Math/Physics</option>
                          <option value="M.C.A">English Lit</option>
                          <option value="B.Sc.I.T">Kiswahili Fasihi</option>
                          <option value="B.Sc.C.S">BST/GEO</option>
                          <option value="M.Sc.I.T">CHEM/MATH</option>
                          <option value="M.Sc.C.S">HIST/KISW</option>
                          <option value="M.B.A">CRE/AGR</option>
                          <option value="B.B.A">MATH/CHEM</option>
